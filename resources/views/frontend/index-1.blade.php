            ...
            <div class="row">
                <div class="col-md-6 d-flex justify-content-md-end justify-content-center">
                    ...
                    <img src="{{ asset( $about_us->image) }}" class=""
                       >
                        <span> 300+ <em>Courses</em> </span>
</div>
                    @else
                     <div class="aboutimg"> 
                    <img class=""
                    src="{{ asset('img/slider1.png') }}" alt="About Us" />
                     <span> 300+ <em>Courses</em> </span>
</div>
                    @endif
                </div>
                <div class="col-md-6 aboutext">
                  <h5>  @if (isset($about_us->title))
                                {{ $about_us->title }}
                            @endif</h5> 
                         {{-- {{ dd($about_us) }} --}}   
                    <p class="mb-4">{!! $about_us->content !!}</p>

                    <ul class="aboutlicons">
<li><img src="{{ asset('assets/img/icon5.png') }}" alt="Continuous Improvement
">   <span>Continuous Improvement
</span> </li>
<li><img src="{{ asset('assets/img/icon6.png') }}" alt="Gamification">   <span>Gamification</span> </li>
<li><img src="{{ asset('assets/img/icon7.png') }}" alt="Automation">   <span>Automation</span> </li>
    </ul>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-12 d-flex align-items-center order-md-3 my-sm-4">
                    <div class="inner">
                         <div class="vm vimg">
                        <img src="{{ asset('assets/img/icon9.png') }}" alt="Our Vision">
                ...
                <div class="col-lg-6 col-md-6 col-12 d-flex align-items-center order-md-2">
                    <div class="inner ">
                        <div class="vm mimg">
                        <img src="{{ asset('assets/img/icon8.png') }}" alt="Our Mission">
        ...
        <div class="container">
            <div class="row">
                <div class="w-100 d-flex justify-content-between items-center section-title-3">
                    ...
                    <h2>@lang('News') <strong>@lang('& Updates')</strong></h2>
