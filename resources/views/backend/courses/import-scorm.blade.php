...
<form method="POST" action="{{ route('admin.courses.uploadscorm') }}" id="addCourse" enctype="multipart/form-data">
    @csrf
    ...
    <div class="">
        <div class="pb-3 d-flex justify-content-between addcourseheader">
            ...
            <h5>
                @lang('strings.backend.general.app_import_course')
            </h5>
        ...
        <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-lg-4 col-md-12 form-group">
                                <div style="margin-bottom: 21px;">
                                    {{ __('course_pages.admin_create.scorm_package') }} *
                                </div>

                                <div class="custom-file-upload-wrapper">
                                    <input type="file" name="scorm_package" id="scorm_package" class="custom-scromfile-input" accept=".zip" required>
                                    <label for="scorm_package" class="custom-file-label">
                ...
                <div class="row">
                    <div class="col-md-12 form-group">
                        ...
                        <!-- <input class="course-type ml-2 mr-2" type="radio" name="course_type" value="Offline" disabled readonly/>
                        {{ __('course_pages.admin_create.course_type_live_online') }}
                        <input class="course-type ml-2 mr-2" type="radio" name="course_type" value="Live-Classroom" disabled readonly />
                        ...
                        <div class="col-12 d-flex float-right gap-20">
                            ...
                            <div class="">
                                <input class="btn add-btn frm_submit" id="doneBtn" type="submit"
                                    value="{{ __('assignment_pages.user_details.submit') }}">
                            </div>
                            <!-- <div class="">
...
@push('after-scripts')
    ...
    $(".js-example-placeholder-single").select2({
        ...
        allowClear: false
            ...
            $("#category_id").select2({
                placeholder: "Select Teacher",
                placeholder: "{{ trans('course_pages.admin_create.select_category') }}",
            });
    ...
    <script>
        ...
        $('#addCourse').on('submit', function (e) {
            ...
            setTimeout(() => {
                ...
                let url = '{{ route('admin.courses.uploadscorm') }}'
                let val = $('#nextBtn').val();
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        if (res && res.status === 'success') {
                                ...
                                toastr.success(res.clientmsg || 'Success');

                            } else {
                                toastr.error(res.clientmsg || 'Something went wrong');
                            }
                    },
    ...
    <script>
        ...
        document.querySelectorAll('.custom-scromfile-input').forEach(function (input) {
            input.addEventListener('change', function (e) {
                ...
                if (!files.length) {
                    label.innerHTML = '<i class="fa fa-upload mr-1"></i> {{ __("course_pages.admin_create.choose_file") }}';
                    return;
                }
                ...
                // ✅ 3. Validate file size (50MB example)
                ...
                // ✅ 4. Update label (only if valid)
                label.innerHTML = '<i class="fa fa-upload mr-1"></i> ' + file.name;
            });
        });
    </script>
