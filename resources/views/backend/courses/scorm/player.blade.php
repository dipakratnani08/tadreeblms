...
const settings = {
    ...
    trackUrl: "{{ route('admin.lessons.scorm.track', ['scoUuid' => $firstSco->uuid ?? 'none']) }}",
    getTrackingUrl: "{{ route('admin.lessons.scorm.getTracking', ['scoUuid' => $firstSco->uuid ?? 'none', 'scormVersion' => $scorm->version ?? 'scorm_12']) }}"
};
